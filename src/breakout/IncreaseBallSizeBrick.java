...
/**
 * The purpose of this class is to be the certain brick power up related to increasing the Ball size if
 ...
 * this class is also related to the Ball class because it calls the increaseBallSize() method found in the
 ...
 * configuration.
 */
public class IncreaseBallSizeBrick extends BrickWithPowerUp {

  @Override
  public void destroyBrickWhenPaddleHits(Level currentLevel) {
    currentLevel.getBall().increaseBallSize();
  }
