 ...
 * depends on the level class, because the destroyBrickWhenPaddleHit/ updateHitToBrick function
 * takes in a level object. You use this class by instantiating then initializing and adding to a
 * list of bricks that are placed on the screen for breakout game.
 *
